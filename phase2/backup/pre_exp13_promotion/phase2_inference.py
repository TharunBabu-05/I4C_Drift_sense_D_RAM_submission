...
class Phase2InferenceEngine:
    def __init__(self, checkpoint_path="best_model_level1.pth", config=None, device="cpu"):
    ...
    def localize_pair(
        ...
        # EXP-10 PROMOTION: Pure NCC Primary Ranking (argmax(ncc_norm))
        # Ranks candidates primarily by NCC score descending; ties broken by adjusted_score.
