#!/usr/bin/env python3
"""
Generate Pair 2 for Grayscale Capacitorless Double-Gate DRAM (Top GT 500,310)
==============================================================================
Synthesizes 1000x1000 Grayscale SEM image matching Capacitorless Double-Gate DRAM structure:
  ...
  - Seamless Ground Truth Target Landmark at Top (500, 310): Cluster of adjacent double-gate cells
...
def render_doublegate_dram_scene(h=1000, w=1000, gt_x=500, gt_y=310, seed=12002):
...
# [STRIPPED] def add_sem_noise_grayscale(image_uint8, seed=12002, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_cdg_pair2(output_dir="generated_cdg/pair2", gt_x=500, gt_y=310, seed=12002):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale Capacitorless Double-Gate DRAM - Top GT 500,310 (Pair 2)",
        "pair_id": "pair2",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_cdg_pair2] Successfully generated Double-Gate DRAM pair 2 {output_dir} | GT: ({gt_x}, {gt_y})")
