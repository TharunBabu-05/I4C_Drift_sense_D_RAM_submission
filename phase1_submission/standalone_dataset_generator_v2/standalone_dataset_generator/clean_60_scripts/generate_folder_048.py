#!/usr/bin/env python3
"""
Generate Pair 2 for Grayscale VCT 4F2 DRAM (Top GT 500,310)
============================================================
...
def render_vct_dram_scene(h=1000, w=1000, gt_x=500, gt_y=310, seed=19002):
...
# [STRIPPED] def add_sem_noise_grayscale(image_uint8, seed=19002, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_vct_pair2(output_dir="generated_vct/pair2", gt_x=500, gt_y=310, seed=19002):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale VCT 4F2 DRAM - Top GT 500,310 (Pair 2)",
        "pair_id": "pair2",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_vct_pair2] Successfully generated VCT 4F2 DRAM pair 2 {output_dir} | GT: ({gt_x}, {gt_y})")
