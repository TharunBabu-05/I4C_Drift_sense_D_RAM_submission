#!/usr/bin/env python3
"""
Generate Pair 1 for generated_new (Grayscale Normal Image Vertical Channel DRAM 1T1C - Center GT 500,500)
========================================================================================================
Synthesizes 1000x1000 Grayscale normal image matching SEM micro-photo of Vertical Channel DRAM (1T1C) IC structure:
  ...
  - Seamless Ground Truth Target Landmark at Center (500, 500): 6 adjacent DRAM cell squares joined with thin interconnect lines
...
def render_normal_vertical_channel_dram_scene(h=1000, w=1000, gt_x=500, gt_y=500, seed=3001):
...
# [STRIPPED] def add_heavy_sem_noise_grayscale(image_uint8, seed=3001, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_new_pair1(output_dir="generated_new/pair1", gt_x=500, gt_y=500, seed=3001):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale Normal Image DRAM (Interconnected Cell Squares Cluster) - Center GT 500,500 (Pair 1)",
        "pair_id": "pair1",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_new_pair1] Successfully generated DRAM interconnected cell cluster pair 1 {output_dir} | GT: ({gt_x}, {gt_y})")
