#!/usr/bin/env python3
"""
Generate Dataset Pair 2 (Hyper-Dense Crisp SEM Cell Grid + Heavy Noise + Unique Circle Target)
==================================================================================================
...
Design Features:
  ...
  - UNIQUE TARGET LANDMARK: At Ground Truth (350, 630), junction is a UNIQUE CIRCLE pad.
  - Extreme SEM noise (Poisson scale = 8.0, Gauss sigma = 18.0).

Output files in generated_pairs/pair2/:
  - groundtruth.json
...
def render_hyperdense_crisp_sem_scene(h=1000, w=1000, gt_x=350, gt_y=630, seed=802):
    """
...
# [STRIPPED] 
# [STRIPPED] 
def generate_pair2(output_dir="generated_pairs/pair2", gt_x=350, gt_y=630, seed=802):
    """Generate pair2 files with hyper-dense crisp cell grid and extreme SEM noise."""
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Hyper-Dense Crisp SEM Cell Grid with Unique Circle Target Landmark 2",
        "pair_id": "pair2",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_pair2] Successfully generated hyper-dense pair {output_dir} | GT: ({gt_x}, {gt_y})")
