#!/usr/bin/env python3
"""
Generate Pair 2 for generated_1tdram (Grayscale Capacitorless 1T DRAM - Top GT 500,310)
=======================================================================================
Synthesizes 1000x1000 Grayscale normal image matching SEM micro-photo of 1T DRAM IC structure:
  ...
  - Seamless Ground Truth Target Landmark at Top (500, 310): Cluster of adjacent 1T DRAM cells
...
def render_1tdram_scene(h=1000, w=1000, gt_x=500, gt_y=310, seed=10002):
...
# [STRIPPED] def add_sem_noise_grayscale(image_uint8, seed=10002, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_1tdram_pair2(output_dir="generated_1tdram/pair2", gt_x=500, gt_y=310, seed=10002):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale 1T DRAM - Top GT 500,310 (Pair 2)",
        "pair_id": "pair2",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_1tdram_pair2] Successfully generated 1T DRAM pair 2 {output_dir} | GT: ({gt_x}, {gt_y})")
    return os.path.join(output_dir, "search.png"), os.path.join(output_dir, "target.png"), gt_info


if __name__ == "__main__":
    generate_1tdram_pair2()
