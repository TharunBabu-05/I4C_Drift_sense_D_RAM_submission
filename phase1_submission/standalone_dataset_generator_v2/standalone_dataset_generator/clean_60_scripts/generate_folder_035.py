#!/usr/bin/env python3
"""
Generate Pair 1 for Grayscale GIDL-based Capacitorless DRAM (Center GT 500,500)
==============================================================================
Synthesizes 1000x1000 Grayscale SEM image matching GIDL (Gate-Induced Drain Leakage) 1T1D Cell DRAM:
  ...
  - Subtle In-Pattern Embedded Landmark at Center (500, 500):
...
def render_gidl_dram_scene(h=1000, w=1000, gt_x=500, gt_y=500, seed=13001):
    ...
    # Join two adjacent cell boxes together (no big white mark!)
...
# [STRIPPED] def add_sem_noise_grayscale(image_uint8, seed=13001, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_gidl_pair1(output_dir="generated_gidl/pair1", gt_x=500, gt_y=500, seed=13001):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale GIDL-based Capacitorless DRAM - Center GT 500,500 (Pair 1)",
        "pair_id": "pair1",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_gidl_pair1] Successfully generated GIDL DRAM pair 1 {output_dir} | GT: ({gt_x}, {gt_y})")
