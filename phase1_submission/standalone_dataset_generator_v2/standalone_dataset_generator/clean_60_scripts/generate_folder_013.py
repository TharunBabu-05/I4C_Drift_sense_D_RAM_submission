#!/usr/bin/env python3
"""
Generate Pair 3 for generated_new (50-Chip Silicon Wafer Array - 484-Point Joined Matrix - Bottom 500,690)
=======================================================================================================
...
Design Features:
  ...
  - UNIQUE TARGET LANDMARK (Pair 3 - Bottom Chip 500,690 [ANOTHER CHIP!]): The 484 points are JOINED together by
...
def render_semiconductor_wafer_scene(h=1000, w=1000, gt_x=500, gt_y=690, seed=2003):
...
# [STRIPPED] def add_heavy_multi_sem_noise(image_uint8, seed=2003, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_new_pair3(output_dir="generated_new/pair3", gt_x=500, gt_y=690, seed=2003):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "50-Chip Silicon Wafer Array (484-Point Joined Matrix - Bottom GT 500,690) 3",
        "pair_id": "pair3",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_new_pair3] Successfully generated pair 3 {output_dir} | GT: ({gt_x}, {gt_y})")
