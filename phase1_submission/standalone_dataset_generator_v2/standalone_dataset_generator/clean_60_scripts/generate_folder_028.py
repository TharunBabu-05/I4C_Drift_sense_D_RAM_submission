#!/usr/bin/env python3
"""
Generate Pair 2 for generated_spt (Grayscale Substrate-Plate Trench DRAM - Top GT 500,310)
============================================================================================
Synthesizes 1000x1000 Grayscale SEM image of SPT DRAM IC structure:
  - SPT cell: substrate = capacitor plate, polysilicon storage node fills INSIDE trench
  - Concentric ring cross-section: poly-Si center → dark dielectric → substrate → collar oxide
  - Seamless GT landmark at Top (500, 310)
...
def render_spt_dram_scene(h=1000, w=1000, gt_x=500, gt_y=310, seed=9002):
...
# [STRIPPED] def add_light_noise(image_uint8, seed=9002, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_spt_pair2(output_dir="generated_spt/pair2", gt_x=500, gt_y=310, seed=9002):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale SPT DRAM (Substrate-Plate Trench) - Top GT 500,310 (Pair 2)",
        "pair_id": "pair2",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_spt_pair2] Successfully generated SPT DRAM pair 2 {output_dir} | GT: ({gt_x}, {gt_y})")
