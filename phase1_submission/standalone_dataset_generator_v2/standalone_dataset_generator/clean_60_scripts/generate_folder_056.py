#!/usr/bin/env python3
"""
Generate Pair 2 for Grayscale Vertical Capsule-Pillar DRAM (Top GT 500,310)
================================================================================
Synthesizes 1000x1000 Grayscale SEM image matching Vertical Capsule-Pillar DRAM:
  ...
  - Stored in Script_and_their_images/056/
"""
...
def render_capsulepillar_dram_scene(h=1000, w=1000, gt_x=500, gt_y=310, seed=23002):
...
# [STRIPPED] def add_unique_sem_noise(image_uint8, seed=23002, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_capsulepillar_pair2(output_dir="generated_capsulepillar/pair2", gt_x=500, gt_y=310, seed=23002):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale Vertical Capsule-Pillar DRAM - Top GT 500,310 (Pair 2)",
        "pair_id": "pair2",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_capsulepillar_pair2] Successfully generated Capsule-Pillar DRAM pair 2 {output_dir} | GT: ({gt_x}, {gt_y})")
    return os.path.join(output_dir, "search.png"), os.path.join(output_dir, "target.png"), gt_info


if __name__ == "__main__":
    generate_capsulepillar_pair2()
