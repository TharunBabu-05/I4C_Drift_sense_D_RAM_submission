#!/usr/bin/env python3
"""
Generate Pair 1 for generated_rgb (Extremely Dense Vibrant RGB IC Layout Grid - Unique Circle Target)
===================================================================================================
...
Design Features:
  ...
  - UNIQUE TARGET LANDMARK: At Ground Truth (500, 500), the central square is replaced with
    a UNIQUE VIBRANT CONCENTRIC CIRCLE landmark!
  - Heavy imaging noise applied across RGB channels.

Files created in generated_rgb/pair1/:
  - groundtruth.json
...
def render_extremedense_rgb_ic_layout_scene(h=1000, w=1000, gt_x=500, gt_y=500, seed=901):
    """
...
# [STRIPPED] 
# [STRIPPED] 
def generate_rgb_pair1(output_dir="generated_rgb/pair1", gt_x=500, gt_y=500, seed=901):
    """Generate extremely dense RGB pair1 files with UNIQUE CIRCLE target landmark."""
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Extremely Dense RGB IC Layout Grid with Unique Circle Target Landmark 1",
        "pair_id": "pair1",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_rgb_pair1] Successfully generated extremely dense RGB {output_dir} | GT: ({gt_x}, {gt_y})")
