#!/usr/bin/env python3
"""
Generate Pair 1 for generated_new (Dense Grayscale SEM Layout + Barrel + Vignette + Multi-Noise)
===============================================================================================
...
Design Features:
  ...
  - UNIQUE TARGET LANDMARK: At Ground Truth (490, 490), junction is a UNIQUE SOLID CIRCLE pad.
...
def render_dense_sem_chip_layout_scene(h=1000, w=1000, gt_x=490, gt_y=490, seed=1001):
    """
...
# [STRIPPED] def add_multi_type_sem_noise(image_uint8, seed=1001):
# [STRIPPED]     """
...
# [STRIPPED] 
# [STRIPPED] 
def generate_new_pair1(output_dir="generated_new/pair1", gt_x=490, gt_y=490, seed=1001):
    """Generate dense grayscale pair1 files with barrel, vignette, and multi-noise."""
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Dense Grayscale SEM Layout with Barrel, Vignette, and Multi-Noise 1",
        "pair_id": "pair1",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_new_pair1] Successfully generated dense multi-noise {output_dir} | GT: ({gt_x}, {gt_y})")
