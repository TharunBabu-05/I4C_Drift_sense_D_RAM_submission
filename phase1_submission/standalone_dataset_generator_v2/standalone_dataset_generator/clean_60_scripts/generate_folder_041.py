#!/usr/bin/env python3
"""
Generate Pair 1 for Grayscale 3D Capacitorless DRAM (Center GT 500,500)
========================================================================
Synthesizes 1000x1000 Grayscale SEM image matching 3D Capacitorless DRAM architecture:
  ...
  - Embedded Double-Pillar Landmark at Center (500, 500):
...
def render_3dcdram_scene(h=1000, w=1000, gt_x=500, gt_y=500, seed=16001):
...
# [STRIPPED] def add_sem_noise_grayscale(image_uint8, seed=16001, is_target=False):
...
# [STRIPPED] 
# [STRIPPED] 
def generate_3dcdram_pair1(output_dir="generated_3dcdram/pair1", gt_x=500, gt_y=500, seed=16001):
    h, w = 1000, 1000
    ...
    gt_info = {
        "center_x": gt_x,
        "center_y": gt_y,
        "target_name": "Grayscale 3D Capacitorless DRAM - Center GT 500,500 (Pair 1)",
        "pair_id": "pair1",
        "scale_factor": 10.0
    }
    ...
    print(f"[generate_3dcdram_pair1] Successfully generated 3D Capacitorless DRAM pair 1 {output_dir} | GT: ({gt_x}, {gt_y})")
    return os.path.join(output_dir, "search.png"), os.path.join(output_dir, "target.png"), gt_info


if __name__ == "__main__":
    generate_3dcdram_pair1()
